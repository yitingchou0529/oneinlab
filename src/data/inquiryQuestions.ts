...
export const ART_MATERIALS: ArtMaterial[] = [
  ...
  { name: '水彩', icon: '🎨', desc: '流動情緒、渲染放鬆、促進非理性情感宣洩', suitableActivities: '接力自畫像、面具創作' },
  { name: '蠟筆', icon: '🖍️', desc: '直覺塗鴉、質樸觸感、抗拒低退化度高', suitableActivities: '接力自畫像、六格畫、面具創作' },
  { name: '毛根', icon: '🧶', desc: '立體塑造、空間感知、可反覆折疊容錯率高', suitableActivities: '襪子娃娃、JEANSFRAME' },
  { name: '輕黏土', icon: '❤️', desc: '柔軟可塑、舒壓排遣、雙手揉捏本體感回饋', suitableActivities: '' },
  { name: '軟陶', icon: '🏺', desc: '細緻雕琢、定型留存、具備成果儀式感', suitableActivities: '' },
  { name: '報紙', icon: '📰', desc: '撕揉發洩、即興拼貼、低成本且易於破除完美主義', suitableActivities: '報紙找碴' },
  { name: '雜誌', icon: '📖', desc: '意象剪貼、視覺隱喻、降低繪畫焦慮的拼貼首選', suitableActivities: '旅程地圖、報紙找碴' },
  { name: '氣球', icon: '🎈', desc: '呼吸象徵、輕盈互動、宣洩緊張與肢體破冰', suitableActivities: '身體傳球' },
  { name: '面具', icon: '🎭', desc: '人格投射、內外在自我對照、安全偽裝防衛機制', suitableActivities: '面具創作、接力自畫像' },
  { name: '熱縮片', icon: '🪄', desc: '縮小轉化、護身象徵、具神奇趣味的轉化歷程', suitableActivities: '' },
  { name: '布、衣服', icon: '🧵', desc: '溫暖觸感、生命記憶、依附關係與懷舊安全感', suitableActivities: '襪子娃娃、JEANSFRAME' },
];
